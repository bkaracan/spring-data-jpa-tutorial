...
public class SaveBookBean extends AbstractResponsePayload {
  ...
  @Autowired
  public SaveBookBean(
      BookRepository bookRepository, AuthorRepository authorRepository, BookMapper bookMapper) {
  ...
  public ResponsePayload<BookResponseDTO> save(BookRequestDTO requestDTO) {
    ...
    return createSuccessResponse(
        MessageEnum.SAVE_SUCCESS.getMessage(), bookMapper.toResponseDTO(savedBook));
  }
}
